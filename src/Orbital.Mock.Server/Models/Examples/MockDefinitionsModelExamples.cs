    ...
    public class MockDefinitionsModelExamples : IExamplesProvider
    {
        ...
        public object GetExamples()
        {
            ...
            scenarios.Add(new Scenario()
            {
                ...
                Verb = 0,
                Path = "/pets",
                Response = new MockResponse { Status = 0, Body = "Scenario 1", Headers = headers[0], ResponseType = ResponseType.CUSTOM },
            ...
            scenarios.Add(new Scenario()
            {
                ...
                Verb = 0,
                Path = "/pets",
                Response = new MockResponse { Status = StatusCodes.Status200OK, Body = "Testing scenario 2", Headers = headers[1], ResponseType = ResponseType.CUSTOM },
            ...
            scenarios.Add(new Scenario()
            {
                ...
                Verb = 0,
                Path = "/pets",
                Response = new MockResponse { Status = StatusCodes.Status200OK, Body = "Scenario 3", Headers = headers[2], ResponseType = ResponseType.CUSTOM },
                RequestMatchRules = new RequestMatchRules {
