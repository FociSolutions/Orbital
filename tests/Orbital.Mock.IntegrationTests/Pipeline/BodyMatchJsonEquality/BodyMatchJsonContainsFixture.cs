...
namespace Orbital.Mock.Server.IntegrationTests.Pipeline.BodyMatchJsonEquality
{

    public partial class BodyMatchFixtureJsonEquality_Feature : FeatureFixture
    {
        ...
        private readonly string bodyMock =
            JToken.Parse(CommonData.GetMockDefinitionText(CommonData.MockDefinition.BodyJsonContains))["scenarios"][5]
        ...
        public BodyMatchFixtureJsonEquality_Feature()
        {
        ...
        {
            content = new StringContent(CommonData.GetMockDefinitionText(CommonData.MockDefinition.BodyJsonContains),
